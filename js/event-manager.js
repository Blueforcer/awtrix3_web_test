...
/**
 * Navigation Manager for handling page transitions
 */
export class NavigationManager {
  ...
  static async loadPage(pageId) {
    ...
    try {
      ...
      try {
        ...
        pageContent.innerHTML = `<div class="card text-danger">Error loading page: ${error.message}</div>`;
        throw error;
      } finally {
  ...
  static goBack() {
    if (NavigationManager.canGoBack()) {
      NavigationManager.#history.pop(); // Remove current page
